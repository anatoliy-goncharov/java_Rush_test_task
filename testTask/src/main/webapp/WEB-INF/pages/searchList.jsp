...
<body>
	<center>
        ...
        <div style="color: red; font-size: 20px">No search results</div>
        </c:if>
		<c:if test="${!empty searchUsers}">
		...
		<a href="list"><input type="button" value="See all User"></a>
		<a href="search"><input type="button" value="New search"></a>
	</center>
</body>
</html>
